...
Another contingency table included in this package is named **cont3x3abstractors**.  You may use it to experiment with the r functions listed above. If you are interessted in the weighted agreement coefficients, you can find more information in [weighting.html](weighting.html).
